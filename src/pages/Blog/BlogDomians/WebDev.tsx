    ...
    <>
      <main className="max-w-7xl m-auto pt-24 pb-10">
        <div className="flex justify-between items-center">
          ...
          <p className="text-gray-200 font-bold text-xl cursor-pointer rounded-2xl ">
            {post.category}
          </p>
        ...
        <h1 className="font-bold py-5 font-serif text-4xl text-gray-50">{post.title}</h1>
        ...
        <div className="descriptions py-3 px-4">
          ...
          <p className="text-gray-200 font-bold pt-5 text-xl leading-9 tracking-wide">
            {post.desc_h9}
          </p>
          <p className="text-gray-200 text-lg leading-9 tracking-wide">
            {post.desc_p7}
